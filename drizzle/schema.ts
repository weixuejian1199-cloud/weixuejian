...
export const sessions = mysqlTable("sessions", {
  ...
  /** V3.0: Pipeline execution status — null means not started */
  pipelineStatus:     mysqlEnum("pipelineStatus", ["running", "success", "failed"]),
  pipelineError:      text("pipelineError"),
  pipelineStartedAt:  timestamp("pipelineStartedAt"),
  pipelineFinishedAt: timestamp("pipelineFinishedAt"),
