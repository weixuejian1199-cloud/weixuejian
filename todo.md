...
- [ ] C1: 全局主题换肤 — 苹果化设计语言（浅色主题、圆角、毛玻璃、留白、SF Pro 字体）
- [ ] C2: 导航精简 — 左侧栏只保留对话/数据中枢/HR中心/模板库，底部保留设置/分享好礼/知识库
- [ ] C3: 工作台中心化 — 对话框即工作台，文件上传集成在对话框内
- [ ] C4: 手机端适配 — 响应式布局，侧边栏自动折叠，触摸优化
- [ ] C5: 模板落地 UI — 模板选择集成到对话框内（类似 emoji 按钮）
- [ ] C6: 状态指示器 — 思考中/处理中状态显示
- [ ] C7: 单元测试 — UI 组件测试
