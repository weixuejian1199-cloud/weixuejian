...
import type { UIMessage, UIDataTypes, UITools, UIToolInvocation } from "ai";
type UIMessagePart = import('ai').UIMessagePart<UIDataTypes, UITools>;
...
export interface ToolPartRendererProps {
  ...
  part: UIMessagePart & { type: `tool-${string}`; toolCallId?: string; state?: ToolInvocationState; input?: unknown; output?: unknown; errorText?: string };
      ...
      >
        {message.parts.map((part, i) => {
          ...
          if (part.type === "text") {
            ...
            return (
              <div key={i} className="prose prose-sm dark:prose-invert max-w-none">
                <Markdown parseIncompleteMarkdown={isStreaming}>
                  {part.text}
                </Markdown>
              </div>
            );
          ...
          if (part.type.startsWith("tool-")) {
            ...
            const toolPart = part as UIMessagePart & { type: `tool-${string}`; toolCallId?: string; state?: ToolInvocationState; input?: unknown; output?: unknown; errorText?: string };
